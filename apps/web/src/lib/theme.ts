...
export const TEAM_TYPES: Record<TeamType, TeamTypeConfig> = {
  launch: {
    ...
    primaryMetricUnit: '%',
    tabs: ['Today', 'Predictions', 'Team', 'Context', 'Milestones', 'Integrations', 'Risks'],
  ...
  product: {
    ...
    primaryMetricUnit: '%',
    tabs: ['Today', 'Predictions', 'Team', 'Context', 'Sprint', 'Integrations', 'Quality'],
  ...
  agency: {
    ...
    primaryMetricUnit: '%',
    tabs: ['Today', 'Predictions', 'Team', 'Context', 'Projects', 'Integrations', 'Clients'],
  ...
  engineering: {
    ...
    tabs: ['Today', 'Predictions', 'Team', 'Context', 'Velocity', 'Integrations', 'Quality'],
